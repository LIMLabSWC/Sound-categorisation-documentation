...
optuna_search_space = {
    ...
    'eta_learning':   {'low': 0.01,  'high': 1},
    'sigma_boundary': {'low': 0.01, 'high': 10},
    'alpha':          {'low': 1.0,  'high': 1.0}
}

# Create results folder if it doesn't exist
subject_folder = f'/nfs/nhome/live/apourdehghan/Hybrid_SC_fit/Mouse/results/{args.sampler}/{args.p_id}'
