#!/bin/bash
#SBATCH --job-name=hybrid_fit_mouse3
#SBATCH --array=0
...
CONFIG_LINE=$(sed -n "$((SLURM_ARRAY_TASK_ID + 1))p" /nfs/nhome/live/apourdehghan/hybrid_fit_mice_config_list2.txt)
...
LOG_DIR="/nfs/nhome/live/apourdehghan/Hybrid_Fit/Mouse/results/${SAMPLER}/${SUBJECT}/logs"
mkdir -p "$LOG_DIR"
